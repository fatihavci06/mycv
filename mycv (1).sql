...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 12 Eki 2022, 20:40:49
...
(16, '2022_06_08_181849_i_just_love_using_log', 10);

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `mycvlog`
--

CREATE TABLE `mycvlog` (
...
--
-- Tablo için indeksler `mycvlog`
--
ALTER TABLE `mycvlog`
  ADD KEY `mycvlog_level_index` (`level`),
  ADD KEY `mycvlog_channel_index` (`channel`);
