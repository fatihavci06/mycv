  ...
  $(document).ready(function(){
    ...
    $.ajaxSetup({
        ...
        $.ajax({
           ...
           data:{education_date:education_date,university_name:university_name,university_branch:university_branch,description:description,status:status,order:order},
